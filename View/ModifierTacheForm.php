...
<head>
	...
	{
		document.location.replace("../Controlor/MainControlor.php?fun=modTache&id=" + $id );
	}
	
	function deleteTache($id)
	{
		document.location.replace("../Controlor/MainControlor.php?fun=deleteTache&id=" + $id );
	}
...
<body>
	...
	<section id="main" class="column">
		...
		<div class="tab_container">
			...
			<tbody> 
				<?php foreach ( $_SESSION['tachesTab'] as $tache ) { 
					if(($tache[6]."o") == "0o"){
					?>
				<tr> 
    				...
    				<td>
	    				<input type="image" src="images/icn_edit.png" title="Edit" onclick="modifierTache(<?php echo $tache[0];?>)">
