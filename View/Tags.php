...
<body>
	...
	<form style="display: hidden" action="../Controlor/MainControlor.php?fun=ModTag" method="post" id="form">
		<input type="text" size="20" name="oldCat" id="oldCatId" >
		<input type="text" size="20" name="newCat" id="newCatId" >
	</form>
	
	<form style="display: hidden" action="../Controlor/MainControlor.php?fun=deleteTag" method="post" id="form2">
